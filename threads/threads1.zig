...
//
// This code example demonstrates how to use multi-threading and mutexes
// (Mutex) in Zig language to safely update shared data. This is a common
// scenario in concurrent programming, especially when multiple threads
// need to read and modify the same data.
